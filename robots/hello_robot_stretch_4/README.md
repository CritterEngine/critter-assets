...
7. Added `scene.xml` which includes the robot with a ground plane and the upstream floor-to-wheel contact pairs. The robot initializes in the user-authored home pose with enough arm extension to clear the wrist and with the gripper open.
